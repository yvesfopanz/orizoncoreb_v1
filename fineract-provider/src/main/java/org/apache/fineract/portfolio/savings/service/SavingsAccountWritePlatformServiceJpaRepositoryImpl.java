...
public class SavingsAccountWritePlatformServiceJpaRepositoryImpl implements SavingsAccountWritePlatformService {
    ...
    public CommandProcessingResult withdrawal(final Long savingsId, final JsonCommand command) {
        ...
        //Yves FOPA - 18 Oct 2025
        final Long cashierId = this.cashierRepository.findByStaff_id(currentUser.getStaffId()).getFirst().getId();
        this.cashierTransactionDataValidator.validateCashierCashCashOutTransactions(cashierId, transactionAmount, account.getCurrency().getCode());
        //end of added code - Yves FOPA
