...
public class DepositSavingsAccountCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public DepositSavingsAccountCommandHandler(final SavingsAccountWritePlatformService writePlatformService, final PlatformSecurityContext context,final CashierRepository cashierRepository) {
